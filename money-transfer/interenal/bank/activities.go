...
func Withdraw(ctx context.Context, data shared.PaymentDetails) (string, error) {
...
func Deposit(ctx context.Context, data shared.PaymentDetails) (string, error) {
...
func Refund(ctx context.Context, data shared.PaymentDetails) (string, error) {
